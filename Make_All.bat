...
if exist mamba_3_55DEH.lz.bin  move  mamba_3_55DEH.lz.bin  mamba\mamba_355E.lz.bin>nul
...
if exist mamba_3_55DEH.bin  move  mamba_3_55DEH.bin  mamba\bin\mamba_355E.bin>nul
